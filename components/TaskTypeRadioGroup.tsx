...
const types = [
  {
    id: "todo",
    name: "Todo",
    description: "A task that is yet to be done",
    color: "bg-red-500",
  },
  {
    id: "inprogress",
...
function TaskTypeRadioGroup({}: Props) {
              ...
              <RadioGroup.Option
                ...
                className={({ active, checked }) =>
                  `
                      ...
                      relative flex cursor-pointer rounded-lg outline-none focus:outline-none px-5 py-4 shadow-md`
                }
              >
                {({ active, checked }) => (
                  <>
